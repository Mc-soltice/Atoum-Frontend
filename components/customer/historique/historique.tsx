...
// Badge de statut stylisé (original inchangé)
const StatusBadge = ({
  status,
}: {
  status: { value: string; label: string };
...
export default function HistoriqueContent({
  ...
  // Transformation des commandes (identique à l'original)
  useEffect(() => {
    if (contextOrders.length > 0) {
      const transformedOrders: OrderWithDetails[] = contextOrders.map(
        (order) => {
    ...
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          {/* Bouton de tri - toujours en dessous, sur toute largeur sur mobile */}
          {orders.length > 0 && (
            <div className="w-full">
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white font-medium text-sm rounded-lg shadow-md transition-all duration-200 whitespace-nowrap"
              >
                  ...
                  {isExpanded && (
                    <div className="border-t border-gray-100 bg-gray-50/50">
                      <div className="p-4 sm:p-6">
                        {/* Version mobile : cartes verticales (visible sur petits écrans) */}
                        <div className="block md:hidden space-y-3">
                          {order.items.map((item) => (
                            ...
                            >
                              <div className="font-semibold text-gray-900 mb-2 wrap-break-word">
                                {item.product_name}
                              </div>
                          ...
                          {/* Livraison et total (version mobile) */}
                        ...
                        {/* Version desktop : tableau horizontal (visible à partir de md) */}
                            ...
                            <div className="min-w-160">
                              ...
                              <div className="divide-y divide-gray-100">
                                {order.items.map((item) => (
                                  ...
                                  >
                                    <div className="col-span-5 font-medium text-gray-900 wrap-break-word">
                                      {item.product_name}
                                    </div>
                        ...
                        {/* Actions (communes aux deux versions) */}
