            ...
            <div className="p-4 sm:p-6">
              ...
              {items.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <button
                    onClick={closeModal}
                    className="btn bg-linear-to-r from-orange-500 to-green-500 text-white hover:from-orange-600 hover:to-green-600"
                  >
                  ...
                  <div className="lg:col-span-2 space-y-4">
                    ...
                    <div className="space-y-4">
                      {items.map((item) => (
                        <CartItem
                          key={item.product.id}
                          product={item.product}  // ✅ Passez product au lieu de item
                          quantity={item.quantity} // ✅ Passez quantity séparément
                        />
                      ))}
                    </div>
                  </div>
