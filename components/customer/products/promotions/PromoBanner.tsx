  ...
  return (
    <div className="promo-banner-container">
      <div className="promo-banner">
        ...
        {/* Bouton CTA - visible même sur mobile */}
        <button
          className="promo-cta"
      ...
      <style jsx>{`
        ...
        /* Cache le texte promo entre 500px et 600px */
        ...
        /* Cache le timer entre 400px et 500px */
        ...
        /* Ajuste le padding sur très petit écran */
