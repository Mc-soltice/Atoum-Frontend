...
const Footer = () => {
  ...
  return (
    <footer
      className="bg-linear-to-br from-green-800 via-green-500 to-green-700 text-green-50"
      role="contentinfo"
    ...
    >
      <div className="px-4 py-10 md:py-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                <div className="relative h-16 w-16 rounded-full overflow-hidden shrink-0 ring-2 ring-green-300/30">
                  <Image
                    src="/images/Logo.png"
                    alt="Logo Atoum-ra"
                    fill
                ...
                <div>
                  <span className="font-bold text-2xl text-green-50 block leading-tight drop-shadow-lg">
                    Atoum-ra
                  </span>
              ...
              <p className="text-green-100/90 text-sm leading-relaxed max-w-sm drop-shadow">
              ...
              <div className="grid grid-cols-1 gap-2 pt-1">
                <a href={`tel:${contactInfo.phone.replace(/\s/g, "")}`}
                  className="flex items-center gap-2 text-green-100/90 hover:text-green-50 transition-colors text-sm group">
                ...
                <span className="flex items-center gap-2 text-green-100/90 text-sm">
                  <MapPin size={16} />
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              {/* Navigation */}
              <div>
                <h3 className="text-base font-semibold mb-3 text-green-50 border-b border-green-300/40 pb-1 drop-shadow">
                  Navigation
                </h3>
          ...
          <div className="border-t border-green-300/30 mt-8 pt-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-3">
              <p className="text-green-100/80 text-sm order-2 md:order-1 drop-shadow">
                © {new Date().getFullYear()} <span className="font-semibold text-green-50">Atoum-ra</span>. Tous droits réservés.
              </p>
              ...
              <button
                ...
                className="text-green-100/80 font-medium text-lg  hover:text-green-50 transition-colors flex items-center gap-1 order-3 group"
...
function SocialLink({
  ...
  return (
    <a
      ...
      title={label}
      className="text-green-100/90 hover:text-green-50 transition-all duration-300 p-2 hover:bg-green-600/40 rounded-full active:scale-95"
    >
      {children}
    </a>
  );
...
function QuickLink({
  ...
  return (
    <Link
      href={href}
      className="group text-green-100/90 hover:text-green-50 transition-all duration-300 block text-sm"
    >
...
function EngagementItemCompact({
  ...
  return (
    <div className="group flex items-start text-green-100/90 hover:text-green-50 transition-colors duration-300">
      <span className="mr-2 text-green-300 text-base shrink-0 drop-shadow">✓</span>
      <div className="transition-all duration-300 group-hover:translate-x-0.5">
        ...
        <p className="text-xs text-green-200/90 mt-0.5">
          {description}
        </p>
      </div>
    </div>
...
function LegalLink({
  ...
  return (
    <Link
      href={href}
      className="hover:text-green-50 transition-colors duration-300 text-green-100/80 text-sm drop-shadow"
    >
      {children}
    </Link>
  );
